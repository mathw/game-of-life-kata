...
{
    [TestFixture]
    public class RunnerOverpopulationTests
    {
        ...
        [OneTimeSetUp]
        public void GivenAnOverpopulatedArrayOfCells_WhenTheGameIsRun()
        {
            _providedCells = new[,]{
            ...
            _expectedCells = new[,]{
                {new Cell {Alive = false}, new Cell {Alive = true}, new Cell {Alive = true}, new Cell {Alive = false}},
                {new Cell {Alive = false}, new Cell {Alive = false}, new Cell {Alive = false}, new Cell {Alive = true}},
                {new Cell {Alive = false}, new Cell {Alive = true}, new Cell {Alive = true}, new Cell {Alive = false}},
                {new Cell {Alive = false}, new Cell {Alive = false}, new Cell {Alive = false}, new Cell {Alive = false}}
            };
